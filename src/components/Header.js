...
export const Header = () => {
    ...
    useEffect(() => {
        ...
        if (darkMode) {
            document.documentElement.classList.add(DARK_BG);
        } else {
            document.documentElement.classList.remove(DARK_BG);
        }
    }, [darkMode]);
    ...
    const handleActiveNav = ({isActive}) => isActive ? activeClass : inActiveClass;
            ...
            <nav className="bg-white border-b-2 border-gray-200 dark:border-b-1 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span
                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cinema</span>
                    </Link>
                    <div id="mobile-nav" className="flex md:order-2">
                        <button
                            className="inline-flex items-center mr-1 py-2 px-3 justify-center text-sm text-gray-500 rounded-lg md:block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                            onClick={() => {
